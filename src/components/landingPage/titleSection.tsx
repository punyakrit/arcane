...
function TitleSection({ title, subHeading, pill }: TitleSectionProps) {
  return (
    <>
      <section className="flex flex-col items-start justify-center md:items-center ">
        <article className="rounded-full p-[1px] text-sm dark:bg-gradient-to-r dark:from-brand-primary-blue dark:to-brand-primary-purple">
